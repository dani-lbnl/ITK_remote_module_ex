 ...
 *
 *=========================================================================*/
#ifndef itkDanceFilter_hxx
#define itkDanceFilter_hxx

#include "itkDanceFilter.h"
...
DanceFilter< TInputImage, TOutputImage >
::DanceFilter()
{
}
...
::DynamicThreadedGenerateData( const OutputRegionType & outputRegion)
{
  ...
  {
    out.Set( in.Get() *3 +2  ); //simple exercise on how to modify the template
  }
}

} // end namespace itk

#endif // itkDanceFilter_hxx
